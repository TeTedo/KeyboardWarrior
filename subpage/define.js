...
forlogininput[0].onkeydown = function(e){
    ...
    if(e.keyCode == 13){
        if(forlogininput[0].value == "admin" && forlogininput[1].value == "admin"){
            ...
            let tempslideButtonAddModify = document.querySelector('.slideButtonAddModify')
            let tempmodifyGameListbutton = document.querySelector('.modifyGameListbutton')
            let tempadminModeAdd = document.querySelector('.adminModeAdd')
            tempslideButtonAddModify.style.display = "block"
            tempmodifyGameListbutton.style.display = "block"
            tempadminModeAdd.style.display = "block"
        }
    }
